...
public:
	...
	: ::DBus::InterfaceAdaptor("org.zedroot.Douane")
	{
		...
		bind_property(DaemonStatus, "s", true, false);
		register_method(Douane_adaptor, SetStatus, _SetStatus_stub);
		register_method(Douane_adaptor, GetRules, _GetRules_stub);
	}

	::DBus::IntrospectedInterface *introspect() const 
	{
		static ::DBus::IntrospectedArgument SetStatus_args[] = 
		{
			{ "state", "b", true },
			{ 0, 0, 0 }
		};
...
public:
	...
	::DBus::PropertyAdaptor< std::string > DaemonStatus;
...
public:
	 ...
	 */
	virtual void SetStatus(const bool& state) = 0;
...
private:
	 ...
	 */
	::DBus::Message _SetStatus_stub(const ::DBus::CallMessage &call)
	{
